...
public class GeneralCreationTests {
     ...
     * 
     * The creation of the product can only fail with an IllegalArgumentException.
     * @param <Assert> allows a generic impementation of everytype who implements the IAssert interface.
     * @param getAsserts returns the assertcases used as input for the creation in order to test it.
     * @param create creates a domain class with the input from IAssert. The creation may throw an IllegalArgumentException.
     */
