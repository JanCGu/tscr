...
public class ProductStorer implements IProductSetter{
     ...
     * @param reference this list is converted to the list of productdtos and then passted to the function.
     * @param doOperation 
     * @return Returns true if the output of doOperation is greater than 0 or if reference has no elements.
     */
